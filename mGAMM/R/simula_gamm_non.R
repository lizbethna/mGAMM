...
### Functions
### Right Truncated Normal I[Z < trb]
...
# Define the penalization $S1$ y $S2$
# This generate the differentiation matrix
#“k” is the number of splines
...
ggplot(data1, aes(x=time, y=Ytrue, group=id)) +
  theme_bw()+
...
ggplot(data1, aes(x=x1, y=Ytrue, group=id)) +
  theme_bw()+
  geom_point(cex=0.8,color=id) +
  geom_line(lwd=0.1,color=id) +
...
ggplot(data1, aes(x=x2, y=Ytrue, group=id)) +
  theme_bw()+
  geom_point(cex=0.8,color=id) +
  geom_line(lwd=0.1,color=id) +
...
ggplot(data1, aes(x=x1, y=f1_con_error, group=id)) +
  theme_bw()+
  geom_point(cex=0.8,color=id) +
  geom_line(lwd=0.1,color=id) +
...
ggplot(data1, aes(x=x1, y=Yerror, group=id)) +
  theme_bw()+
  geom_point(cex=0.8,color=id) +
  geom_line(lwd=0.1,color=id) +
...
ggplot(data1, aes(x=x2, y=Yerror, group=id)) +
  theme_bw()+
  geom_point(cex=0.8,color=id) +
  geom_line(lwd=0.1,color=id) +
